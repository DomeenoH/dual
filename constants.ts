...
export const MODELS: AiModel[] = [
  ...
  },
  {
    ...
    apiName: GEMINI_3_FLASH_MODEL_ID,
    supportsThinkingConfig: true,
    supportsSystemInstruction: true,
  },
  {
...
export const DEFAULT_COGNITO_MODEL_API_NAME = GEMINI_3_FLASH_MODEL_ID;
export const DEFAULT_MUSE_MODEL_API_NAME = GEMINI_3_FLASH_MODEL_ID;
...
export const THINKING_BUDGET_RANGES: { [key: string]: { min: number; max: number } } = {
  ...
  [GEMINI_3_FLASH_MODEL_ID]: { min: 512, max: 24576 },
  [GEMINI_2_5_FLASH_LITE_MODEL_ID]: { min: 512, max: 24576 },
};

export const GEMINI_3_RO_MODELS: string[] = [GEMINI_3_PRO_MODEL_ID, GEMINI_3_FLASH_MODEL_ID];
